...
const LANG_OPTIONS = ['EN', 'NL', 'DE', 'SV', 'DA', 'TH'] as const
const TYPE_KEYS = [
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="bg-white border border-[#E8E2D6] rounded-[12px] p-6 md:p-8 space-y-5">
                ...
                <button
                  ...
                  className="w-full md:w-auto min-w-[200px] px-6 py-3 rounded-lg text-[15px] font-semibold bg-amber-600 hover:bg-amber-700 disabled:opacity-60 disabled:cursor-not-allowed text-white transition-colors duration-200"
                >
