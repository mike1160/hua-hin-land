...
const WA_URL = `https://wa.me/${PHONE}?text=${encodeURIComponent('Hej — I am interested in the Soi 112 Hua Hin land listing.')}`
        ...
        <div className="bg-white border border-[#E8E2D6] rounded-[12px] p-6">
          ...
          <ul className="space-y-2.5 text-sm">
            {[
              ...
              { label: 'Full retirement / visa guide', href: '/life/retirees', display: 'hua-hin-land.com/life/retirees' },
            ].map((link) => (
