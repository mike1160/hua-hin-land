    ...
    <main className="min-h-screen bg-[#FAF7F0] text-[#1A2744]">
      ...
      <div className="relative h-72 flex items-end pb-10 px-6">
        <div className="absolute inset-0">
          <img src="/photo4.jpg" alt={t('heroAlt')} className="w-full h-full object-cover" style={{objectPosition: 'center 40%'}} />
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="bg-white border border-[#E8E2D6] rounded-[12px] p-6">
          <h2 className="text-[#1A2744] text-xl font-semibold mb-4">{t('centerTitle')}</h2>
          ...
          <div className="space-y-2 text-sm mb-4">
            ...
            <div className="flex justify-between border-b border-[#E8E2D6] pb-2"><span className="text-[#5C5247]">{t('phoneLabel')}</span><a href="tel:+66813043819" className="text-[#C8973A] hover:text-[#d4a84f]">+66 81 304 3819</a></div>
            <div className="flex justify-between"><span className="text-[#5C5247]">{t('coordsLabel')}</span><span className="text-[#5C5247] text-xs">12.4776507, 99.8521141</span></div>
          </div>
