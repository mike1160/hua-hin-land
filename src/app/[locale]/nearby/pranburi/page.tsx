...
export default function PranburiNearby() {
  const t = useTranslations('pranburiPage')
    ...
    <main className="min-h-screen bg-[#FAF7F0] text-[#1A2744]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="bg-white border border-[#E8E2D6] rounded-[12px] p-6">
          <h2 className="text-[#1A2744] text-xl font-semibold mb-4">{t('beachTitle')}</h2>
          ...
          <div className="space-y-2 text-sm mb-4">
            ...
            <div className="flex justify-between"><span className="text-[#5C5247]">{t('coordsLabel')}</span><span className="text-[#5C5247] text-xs">12.3968217, 99.9954352</span></div>
          </div>
        ...
        <div className="bg-white border border-[#E8E2D6] rounded-[12px] p-6">
          <h2 className="text-[#1A2744] text-xl font-semibold mb-4">{t('natureTitle')}</h2>
