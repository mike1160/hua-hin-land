    ...
    <main className="min-h-screen bg-[#07080f] text-white">
      <div className="relative h-72 flex items-end pb-10 px-6">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mt-2" style={{fontFamily: 'Playfair Display, serif'}}>Market Village — 10 minutes.</h1>
          <p className="text-white/60 mt-2">Everyday shopping, dining and services next to Bluport</p>
        </div>
      </div>
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="bg-gradient-to-br from-purple-950/30 to-pink-950/20 border border-purple-900/30 rounded-2xl p-6">
          <h2 className="text-white text-xl font-semibold mb-4">🏪 What you&apos;ll find here</h2>
          <p className="text-white/70 text-sm leading-relaxed mb-4">Market Village is Hua Hin&apos;s established neighbourhood mall — practical, busy and genuinely useful for daily life. Tesco Lotus, hardware stores, phone repair, fashion outlets and dozens of restaurants make it the go-to for residents.</p>
          <ul className="space-y-2 text-white/70 text-sm">
            <li>• <strong className="text-white">Tesco Lotus</strong> — large supermarket for everyday groceries</li>
            <li>• <strong className="text-white">Restaurants & cafés</strong> — Thai, Japanese, Western and fast food</li>
            <li>• <strong className="text-white">Fashion & lifestyle</strong> — mid-range brands and local shops</li>
            <li>• <strong className="text-white">Services</strong> — banks, phone shops, travel agents</li>
          </ul>
        </div>
      </div>
