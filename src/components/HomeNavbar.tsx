...
const navGroups: NavGroup[] = [
  {
    labelKey: 'plotMenu',
    items: [
      { labelKey: 'plot.sizeTerrainAccess', href: '/info/size' },
      { labelKey: 'plot.titleDeed', href: '/info/chanote' },
      { labelKey: 'plot.development', href: '/info/live-and-profit' },
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'area.golfBeaches', href: '/nearby/golf' },
